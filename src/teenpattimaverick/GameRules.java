...
public class GameRules {
    ...
    public void shuffle() {
        Collections.shuffle((List<?>) deck.getCollectionCards());
        randCardsList.addAll((Collection<? extends String>) deck.getCollectionCards());
    }
    ...
    cardList.clear(); // Clear cardList for the current round
    ...
    int c = 0;
    finalList.clear(); // Clear finalList for the current round
    ...
    public void showWinner() {
        ...
        Game winner = result.get(0);
         ...
         for (Game game : result) {
            if (game.getScore() > winner.getScore()) {
                winner = game;
            }
        }
...
public void playRound(List<String> playerNames) {
    // Add players using the provided player names
...
public static void main(String[] args) {
    ...
    try (Scanner scanner = new Scanner(System.in)) {
        ...
        for (int i = 0; i < noOfRounds; i++) {
            ...
            gameRules.playRound(playerNames);
        }
    }
}
}